...
#         transforms.ToTensor()
#     ])
#     img = Image.open("D:\HELEN IMAGES\\train_2\\218904413_1.jpg")
...
#     landmark = landmarks.cpu().detach().numpy().reshape(-1, 2) * [112, 112]
#     print(landmark)
#     for (x, y) in landmark.astype(np.int32):
#         cv2.circle(im, (x, y), 1, (0, 0, 255))

#     cv2.imshow('face_landmark_68', im)
    # lm = landmarks[0]
